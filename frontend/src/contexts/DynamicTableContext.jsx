...
export const DynamicTableContext = createContext(null);
...
export function DynamicTableProvider({ children }) {
  ...
  const updateTable = useCallback(async (tableId, tableData) => {
    ...
    try {
      const response = await fetch(`/api/dynamic/tables/${tableId}/`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const addFieldToTable = useCallback(async (tableId, fieldData) => {
    ...
    try {
      const response = await fetch(`/api/dynamic/tables/${tableId}/add_field/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const fetchRecords = useCallback(async (tableId, filters = {}) => {
    ...
    try {
      let url = `/api/dynamic/records/by_table/?table_id=${tableId}`;
  ...
  const createRecord = useCallback(async (tableId, values) => {
    ...
    try {
      const response = await fetch('/api/dynamic/records/create_with_values/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateRecord = useCallback(async (recordId, values) => {
    ...
    try {
      const response = await fetch(`/api/dynamic/records/${recordId}/update_with_values/`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
